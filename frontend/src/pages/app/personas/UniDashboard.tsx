  ...
  return (
    <PageContainer>
      <div className="mb-6 flex justify-between items-center">
        <div>
          <h1 className="font-display text-2xl font-bold tracking-tight text-silver-900 dark:text-white">Academic Knowledge Terminal</h1>
          <p className="text-sm text-silver-600 dark:text-silver-400">Deep neural vector embeddings for structured material parsing.</p>
        </div>
        <Button variant="outline" size="sm" onClick={onChangePersona} className="text-xs border-silver-300 dark:border-white/10 text-silver-600 dark:text-silver-400 hover:bg-silver-100 dark:hover:bg-white/5">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="md:col-span-2">
          <CardBody className="p-6 text-silver-900 dark:text-white">
            ...
            <p className="text-sm text-silver-600 dark:text-silver-400 leading-relaxed">
        ...
        <Card>
          <CardBody className="p-6 font-mono text-xs text-silver-600 dark:text-silver-400 space-y-2">
